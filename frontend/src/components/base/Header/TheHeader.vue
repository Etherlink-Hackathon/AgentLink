...
const isActive = (linkName) => {
	...
	if (linkName === "Vaults") {
		if (["Vaults", "VaultPage"].includes(route.name)) return true
	}

	if (linkName === "Explore") {
		if (["Explore"].includes(route.name)) return true
	}
				...
				<Flex direction="column" gap="16">
					<Flex direction="column" gap="16">
						...
						<div :class="$style.mobile_menu__links">
							<router-link to="/explore" :class="$style.mobile_menu__link">
								<div :class="$style.left">
									<Icon name="compass" size="14" />
									<span>Explore</span>
								</div>

								<div :class="$style.mobile_menu__description">Opportunities and insights</div>
							</router-link>
							<router-link to="/vaults" :class="$style.mobile_menu__link">
								<div :class="$style.left">
									<Icon name="package" size="14" />
									<span>Vaults</span>
								</div>

								<div :class="$style.mobile_menu__description">Managed arbitrage strategies</div>
							</router-link>
						</div>
					</Flex>
					...
					<Flex direction="column" gap="16">
						...
						<div :class="$style.mobile_menu__links">
							<router-link to="/docs" :class="$style.mobile_menu__link">
								<div :class="$style.left">
							...
							<a href="https://github.com/AgentLink" target="_blank" :class="$style.mobile_menu__link">
								<div :class="$style.left">
		...
		<div :class="$style.base">
			<div :class="$style.left">
				...
				<router-link to="/" :class="$style.logo" tabindex="-1">
					...
					<div :class="$style.logo_text">AgentLink</div>
				</router-link>
			</div>
